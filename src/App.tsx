                        ...
                        <PersonalizedTripContextProvider>
                         <Routes>
                            <Route element={<ProtectedRoutes allowedRoles={"USER"}/>}>
                                ...
                                {/*A mettre avec le layoutBooking*/}
                                ...
                                <Route path="reservationDetails" element={<BookingDetails/>}></Route>

                                <Route path="/booking-mystery-trip" >
                                    <Route element={<LayoutBooking/>} >
                                        ...
                                        <Route path="option" element={<BookingMysteryTripOptions/>}></Route>
                                    </Route>
                            ...
                            <Route path="/personalized-trip" element={<LayoutBooking/>}>
