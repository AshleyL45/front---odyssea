        ...
        <div className="mystery-trip-details-container">
            <section className="component blog-details mystery-trip-details">
                ...
                <div className="text-blog-details">
                    ...
                    <h3 style={{fontSize: "28px", marginBottom: "30px"}} className="mystery-trip-details-title">{title}</h3>
                    <p style={{margin: "30px 0"}} className="mystery-trip-details-paragraph">{paragraph}</p>
                </div>
            </section>
        </div>
    );
