...
const TripSummary: ({}: {}) => JSX.Element = ({}) => {
    ...
    return (
        <>
            <Pages title="Summary - Personnalized Trip">
            </Pages>
            <div className="container-summary">
                ...
                <div className="text-summary">
                    ...
                    <p style={{margin: "40px 0"}}>
                        Welcome to the workshop of your tailor-made trip, where each adventure is designed according to
                        your
                        desires and expectations. Here, every detail counts: adjust your itinerary, add unforgettable
                        stages
                        your itinerary, add unforgettable stages and shape a unique journey that's just like
                        you.<br/><br/>

                        Whether you're dreaming of a secret getaway to little-known places, or a carefully orchestrated
                        journey through several cultures, we offer you the opportunity to create a personalized
                        itinerary,
                        ...
                        landscapes to immersive experiences, every moment will be carefully planned to turn your dream
                        into
