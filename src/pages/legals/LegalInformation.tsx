    ...
    return (
        <>
            ...
            <div className="legal-information">
                ...
                <p>Conformément aux dispositions légales en vigueur, nous mettons à disposition les informations
                    relatives à
                ...
                <p>L'éditeur ne pourra être tenu responsable des erreurs ou indisponibilités du site. L'utilisation du
                    site
                ...
                <p>Le site peut contenir des liens vers des sites tiers. Nous ne pouvons être tenus responsables du
                    contenu
                    ou des pratiques de ces sites.</p>

                <h3>7. Droit Applicable</h3>
                <p>Les présentes mentions légales sont soumises au droit <strong>[juridiction applicable]</strong>. En
                    cas
