    ...
    return (
        <>
            ...
            <div className="cookies-politic">
                ...
                <p>Chez Odyssea, nous utilisons des cookies afin d’améliorer votre expérience utilisateur et d’optimiser
                    nos
                    services. Cette politique explique ce que sont les cookies, comment nous les utilisons et comment
                    vous
                    pouvez les gérer.</p>

                <h3>1. Qu’est-ce qu’un Cookie ?</h3>
                <p>Un cookie est un petit fichier texte déposé sur votre appareil (ordinateur, smartphone, tablette)
                    lorsque
                    vous visitez un site web. Il permet de collecter des informations sur votre navigation pour
                    améliorer
                    votre expérience.</p>
                ...
                <ul>
                    ...
                    <li><strong>Cookies fonctionnels :</strong> Améliorent votre expérience utilisateur (ex. :
                        mémorisation
                        des préférences).
                    </li>
                    <li><strong>Cookies publicitaires :</strong> Utilisés pour vous proposer des publicités ciblées.
                    </li>
                </ul>
                ...
                <p>Lors de votre première visite, un bandeau vous informe de l’utilisation des cookies et vous permet
                    d’accepter, de refuser ou de personnaliser vos choix. Vous pouvez modifier vos préférences à tout
                    moment
